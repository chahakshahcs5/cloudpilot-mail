/* =====================================================
   CloudPilot Mail — SVG Icons (inline)
   ===================================================== */
...
export const Icons = {
  ...
  sent: `<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="m3 3 3 9-3 9 19-9Z"/><path d="M6 12h16"/></svg>`,
